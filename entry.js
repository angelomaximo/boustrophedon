...
LIBER-GENESIS-3
3 Sed et serpens erat callidior cunctis animantibus terrae quae fecerat Dominus Deus. Qui dixit ad mulierem: Cur praecepit vobis Deus ut non comederetis de omni ligno paradisi?
...
30 Ascenditque Lot de Segor, et mansit in monte, duae quoque filiae ejus cum eo (timuerat enim manere in Segor) et mansit in spelunca ipse, et duae filiae ejus cum eo.

31 Dixitque major ad minorem: Pater noster senex est, et nullus virorum remansit in terra, qui possit ingredi ad nos juxta morem universae terrae.
...
37 Peperitque major filium, et vocavit nomen ejus Moab: ipse est pater Moabitarum usque in praesentem diem.
...
LIBER-GENESIS-20
20 Profectus inde Abraham in terram australem, habitavit inter Cades et Sur: et peregrinatus est in Geraris.
...
30 Cumque vidisset inaures et armillas in manibus sororis suae, et audisset cuncta verba referentis: Haec locutus est mihi homo: venit ad virum qui stabat juxta camelos, et prope fontem aquae:

31 dixitque ad eum: Ingredere, benedicte Domini: cur foris stas? praeparavi domum, et locum camelis.

32 Et introduxit eum in hospitium: ac destravit camelos, deditque paleas et foenum, et aquam ad lavandos pedes ejus, et virorum qui venerant cum eo.
...
LIBER-GENESIS-26
26 Orta autem fame super terram post eam sterilitatem, quae acciderat in diebus Abraham, abiit Isaac ad Abimelech regem Palaestinorum in Gerara.
...
5 eo quod obedierit Abraham voci meae, et custodierit praecepta et mandata mea, et caeremonias legesque servaverit.
...
8 Cumque pertransissent dies plurimi, et ibidem moraretur, prospiciens Abimelech rex Palaestinorum per fenestram, vidit eum jocantem cum Rebecca uxore sua.
...
20 Sed et ibi jurgium fuit pastorum Gerarae adversus pastores Isaac, dicentium: Nostra est aqua, quam ob rem nomen putei ex eo, quod acciderat, vocavit Calumniam.
...
28 Qui responderunt: Vidimus tecum esse Dominum, et idcirco nos diximus: Sit juramentum inter nos, et ineamus foedus,
...
34 Esau vero quadragenarius duxit uxores, Judith filiam Beeri Hethaei, et Basemath filiam Elon ejusdem loci:
...
4 Deditque illi Balam in conjugium: quae,
...
8 Si quando dixit: Variae erunt mercedes tuae: pariebant omnes oves varios foetus; quando vero e contrario, ait: Alba quaeque accipies pro mercede: omnes greges alba pepererunt.
...
9 Dixitque Jacob: Deus patris mei Abraham, et Deus patris mei Isaac: Domine qui dixisti mihi: Revertere in terram tuam, et in locum nativitatis tuae, et benefaciam tibi:
...
6 Venit igitur Jacob Luzam, quae est in terra Chanaan, cognomento Bethel: ipse et omnis populus cum eo.
...
9 Apparuit autem iterum Deus Jacob postquam reversus est de Mesopotamia Syriae, benedixitque ei
...
6 Tulit autem Esau uxores suas et filios et filias, et omnem animam domus suae, et substantiam, et pecora, et cuncta quae habere poterat in terra Chanaan: et abiit in alteram regionem, recessitque a fratre suo Jacob.
...
2 Consumptisque cibis quos ex AEgypto detulerant, dixit Jacob ad filios suos: Revertimini, et emite nobis pauxillum escarum.
...
15 Hi filii Liae quos genuit in Mesopotamia Syriae cum Dina filia sua: omnes animae filiorum ejus et filiarum, triginta tres.
...
18 Hi filii Zelphae, quam dedit Laban Liae filiae suae: et hos genuit Jacob sedecim animas.

19 Filii Rachel uxoris Jacob: Joseph et Benjamin.

20 Natique sunt Joseph filii in terra AEgypti, quos genuit ei Aseneth filia Putiphare sacerdotis Heliopoleos: Manasses et Ephraim.

21 Filii Benjamin: Bela et Bechor et Asbel et Gera et Naaman et Echi et Ros et Mophim et Ophim et Ared.

22 Hi filii Rachel quos genuit Jacob: omnes animae, quatuordecim.

23 Filii Dan: Husim.

24 Filii Nephthali: Jasiel et Guni et Jeser et Sallem.

25 Hi filii Balae, quam dedit Laban Racheli filiae suae: et hos genuit Jacob: omnes animae, septem.

26 Cunctae animae, quae ingressae sunt cum Jacob in AEgyptum, et egressae sunt de femore illius, absque uxoribus filiorum ejus, sexaginta sex.

27 Filii autem Joseph, qui nati sunt ei in terra AEgypti, animae duae. Omnes animae domus Jacob, quae ingressae sunt in AEgyptum, fuere septuaginta.
...
`; 
// split word per space
function checkTOŧerArr(txt) {
  const words = [];

  const txtArr = txt.split(" ").map( (x) => x.toLowerCase() )

// if (elem inside arr doesn't include word[i]) => push(words[i])
  for (let i = 0; i < txtArr.length; i++) {
    // doesn't include, i.e. false, ŧen push t word ŧat doesn't
    if (words.includes(txtArr[i]) == false) {
        words.push(txtArr[i])
    }    
  }
